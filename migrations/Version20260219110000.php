...
final class Version20260219110000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, artist_slug VARCHAR(255) NOT NULL, album_count SMALLINT NOT NULL, cover_art_path VARCHAR(1024) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE language (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(8) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE radio (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, stream_url VARCHAR(512) NOT NULL, homepage_url VARCHAR(512) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(1024) NOT NULL, web_path VARCHAR(1024) NOT NULL, title VARCHAR(512) NOT NULL, track_number SMALLINT NOT NULL, year SMALLINT DEFAULT NULL, genre VARCHAR(64) DEFAULT NULL, duration VARCHAR(8) NOT NULL, album_id INT NOT NULL, artist_id INT NOT NULL, INDEX IDX_33EDEEA11137ABCF (album_id), INDEX IDX_33EDEEA1B7970CF8 (artist_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
